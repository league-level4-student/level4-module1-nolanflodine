		...
		if (valid) {
			...
			case ARIES:
				JOptionPane.showMessageDialog(null,
						"Your slow and steady approach may need a sharp kick in the pants today.");
				break;
			case AQUARIUS:
				JOptionPane.showMessageDialog(null,
						"Interaction with others may not be especially satisfying for you today.");
				break;
			case CANCER:
				JOptionPane.showMessageDialog(null,
						"Suddenly you've found your energy again. Your engine is oiled up and ready to go.");
				break;
			case CAPRICORN:
			...
			case LEO:
				JOptionPane.showMessageDialog(null,
						"You may be a bit daunted by the frenzy of energy present in the air today.");
				break;
			case LIBRA:
				JOptionPane.showMessageDialog(null,
						"It's time to implement the plans you fostered as a result of internal processes over the past few days.");
				break;
			case PISCES:
				JOptionPane.showMessageDialog(null,
						"The clouds have finally lifted, and you should be able to see clearly again.");
				break;
			case SAGITTARIUS:
			...
			case VIRGO:
				JOptionPane.showMessageDialog(null,
						"Don't be surprised if unexpected actions from others give your heart a jolt today.");
				break;
			}
		} else {
			System.out.println("Not a valid Zodiac sign");
		}
	}
